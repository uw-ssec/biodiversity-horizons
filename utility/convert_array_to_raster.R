...
# Process all .rds files in the tier_1/data/climate directory and save outputs
process_climate_array_data <- function(input_dir, output_dir, start_year, members = FALSE, use_parallel = TRUE, number_of_workers = availableCores() - 1) {
